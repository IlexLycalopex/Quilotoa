import {
  pgTable, uuid, varchar, boolean, integer, doublePrecision, text,
...
export const discoveryDatasets = pgTable('discovery_datasets', {
  ...
  monthEndDaysActual:  doublePrecision('month_end_days_actual'),
...
export const financialModels = pgTable('financial_models', {
  ...
  // COI inputs
  financeTeamSize:              integer('finance_team_size'),
  financeAnnualSalary:          doublePrecision('finance_annual_salary'),
  manualReentryHrsPerWeekPerFte: doublePrecision('manual_reentry_hrs_per_week_per_fte'),
  monthEndDaysActual:           doublePrecision('month_end_days_actual'),
  errorReworkPct:               doublePrecision('error_rework_pct'),
  auditPrepDays:                doublePrecision('audit_prep_days'),
  reportingCycleDays:           doublePrecision('reporting_cycle_days'),
  itLegacyAnnualCost:           doublePrecision('it_legacy_annual_cost'),
  annualTransactionVolume:      integer('annual_transaction_volume'),
  // COI outputs (snapshot)
  coiManualReentry:    doublePrecision('coi_manual_reentry'),
  coiMonthEnd:         doublePrecision('coi_month_end'),
  coiRework:           doublePrecision('coi_rework'),
  coiAudit:            doublePrecision('coi_audit'),
  coiReporting:        doublePrecision('coi_reporting'),
  coiItLegacy:         doublePrecision('coi_it_legacy'),
  coiTotalAnnual:      doublePrecision('coi_total_annual'),
  // ROI inputs
  implementationInvestment:  doublePrecision('implementation_investment'),
  annualLicenceCost:         doublePrecision('annual_licence_cost'),
  benefitRealisationMonths:  integer('benefit_realisation_months').default(6),
  discountRatePct:           doublePrecision('discount_rate_pct').default(8),
  sensitivityLowMultiplier:  doublePrecision('sensitivity_low_multiplier').default(0.7),
  sensitivityHighMultiplier: doublePrecision('sensitivity_high_multiplier').default(1.3),
  // ROI outputs (snapshot)
  roiPaybackMonths: doublePrecision('roi_payback_months'),
  roi3yrPct:        doublePrecision('roi_3yr_pct'),
  roiNpv:           doublePrecision('roi_npv'),
  roiAnnualBenefit: doublePrecision('roi_annual_benefit'),
  ...timestamps,
})
